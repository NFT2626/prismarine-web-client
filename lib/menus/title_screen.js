  ...
  render () {
    return html`
      <div class="minecraft">
        ...
        <span class="splash">CHADCRAFT is a beautiful block</span>
      </div>
      ...
      <div class="menu">
        ...
        <div class="menu-row">
          <pmui-button pmui-width="98px" pmui-label="Github" @pmui-click=${() => openURL('https://github.com/PrismarineJS/CHADCRAFT-web-client')}></pmui-button>
          <pmui-button pmui-width="98px" pmui-label="Discord" @pmui-click=${() => openURL('https://discord.gg/4Ucm684Fq3')}></pmui-button>
        </div>
      </div>

      <div class="bottom-info">
        <span>CHADCRAFT Web Client</span>
